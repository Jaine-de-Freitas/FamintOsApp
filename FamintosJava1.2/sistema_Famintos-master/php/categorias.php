...
<?php 
    session_start();
        ...
        $consulta = $cn->query("select cd_comida, nm_comida, vl_preco, nm_categoria, img_comida, qt_estoque from tbl_comidas where nm_categoria = '$cat'");
?> 
    ...
    <div class="container-fluid">
        ...
        <?php while($exibe = $consulta->fetch(PDO::FETCH_ASSOC)) { ?>
            <div class="col-sm-3">
                ...
                <div><h4 ><?php echo $exibe['nm_comida']?></h4></div>
